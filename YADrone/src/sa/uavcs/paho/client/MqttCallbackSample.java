...
public class MqttCallbackSample implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MqttCallbackSample sampleClient = new MqttCallbackSample(url, clientId, cleanSession, quietMode, userName,
					password);
	 ...
	 */
	public MqttCallbackSample(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode,
